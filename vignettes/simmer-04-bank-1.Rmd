...
output:
  rmarkdown::html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{The Bank Tutorial: Part I}
...
[_Introduction to simmer_](A-introduction.html), [_Terminology_](B-terminology.html) and [_Advanced Trajectory Usage_](C-trajectories.html).
